...
public class ServerboundAddComponentPacket implements Packet {

    private final MapElement element;
    private final UUID uuid;

    public ServerboundAddComponentPacket(MapElement element, UUID uuid) {
        this.element = element;
        this.uuid = uuid;
    }

    public ServerboundAddComponentPacket(FriendlyByteBuf buf){
